...
function MedFitParkinsons() {
  return (
    <PageLayout>
      <SEO 
        title="MedFit Parkinson's Disease Fitness Specialist Santa Cruz"
        description="MedFit certified Parkinson's Disease Fitness Specialist trained in exercise programs for Parkinson's management. Specialized movement training for Parkinson's in Santa Cruz."
        keywords="parkinsons fitness specialist, parkinsons exercise, movement disorders, parkinsons training santa cruz, medfit certification"
      />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 bg-primary/5 rounded-2xl p-8">
            ...
            <ul className="space-y-3 text-neutralDark/80">
              ...
              <li>• Better gait mechanics and reduced freezing</li>
              <li>• Maintained or improved strength and endurance</li>
              <li>• Slowed progression of motor symptoms</li>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-4 text-neutralDark/80">
              <p>
                <strong className="text-neutralDark">Addressing rigidity:</strong> Structural Integration work can help release fascial restrictions and reduce the physical rigidity that accompanies Parkinson's.
              </p>
              <p>
                <strong className="text-neutralDark">Improving posture:</strong> The forward-flexed posture common in Parkinson's can be partially addressed through hands-on structural work combined with strengthening exercises.
              </p>
              <p>
                <strong className="text-neutralDark">Movement quality:</strong> Structural work creates better movement capacity. Exercise reinforces better movement patterns. Together, they create more significant improvement than either alone.
              </p>
            </div>
          </div>
...
export default MedFitParkinsons;
