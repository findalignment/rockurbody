...
function MedFitRecovery() {
  return (
    <PageLayout>
      <SEO 
        title="MedFit Drug & Alcohol Recovery Fitness Specialist Santa Cruz"
        description="MedFit certified specialist in fitness for addiction recovery. Exercise programs supporting sobriety and recovery in Santa Cruz."
        keywords="recovery fitness specialist, addiction recovery fitness, sobriety fitness, substance abuse recovery santa cruz, medfit certification"
      />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 bg-primary/5 rounded-2xl p-8">
            ...
            <div className="space-y-4 text-neutralDark/80">
              <p>
                <strong className="text-neutralDark">No judgment:</strong> Your past is your past. I'm not here to judge. I'm here to help you move forward.
              </p>
              <p>
                <strong className="text-neutralDark">Meet you where you are:</strong> Whether you're in early recovery or years sober, we start where you are now. No expectations about where you "should" be.
              </p>
              <p>
                <strong className="text-neutralDark">Focus on feeling better:</strong> Not punishment workouts. Not "no pain, no gain." Exercise that actually makes you feel good and want to keep doing it.
              </p>
              <p>
                <strong className="text-neutralDark">Build sustainable habits:</strong> Not extreme programs you'll burn out on. Sustainable exercise habits that support long-term recovery.
              </p>
              <p>
                <strong className="text-neutralDark">Holistic approach:</strong> Combining movement training with structural work (if appropriate) to address both physical limitations and rebuild connection with your body.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <ul className="space-y-3 text-neutralDark/80 ml-6">
              <li>• Start gently. Build gradually.</li>
              <li>• Focus on how you feel, not just what you do</li>
              <li>• Create routine and structure without rigidity</li>
              <li>• Build strength, confidence, and capability</li>
              <li>• Learn to use movement as a healthy coping tool</li>
