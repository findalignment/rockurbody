        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-l-4 border-accent pl-6 mb-16">
            ...
            <p className="text-lg text-neutralDark/80 mb-4 leading-relaxed">
              Fascial release work is different from massage. The pressure is slow and sustained because we're working with the fascia, not just the muscles. Some areas might be tender, but it shouldn't be painful.
            </p>
