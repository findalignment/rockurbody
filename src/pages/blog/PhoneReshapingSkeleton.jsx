...
function PhoneReshapingSkeleton() {
  return (
    <PageLayout>
      <SEO 
        title="Your Phone is Reshaping Your Skeleton (And We Can Do Better) | Rock Your Body"
        description="Technology is literally changing people's bodies. Learn how your fascia adapts to screen time and what we can do about it."
        keywords="text neck, fascia, posture, technology health, structural integration, movement education, ergonomics"
        canonicalUrl="https://rockurbody.com/blog/phone-reshaping-skeleton"
      />
      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            I was working with a client, a 29-year-old software engineer who came in complaining about shoulder pain. Smart guy, active, did everything "right." But when I put my hands on him, I could feel how his entire fascial system had reorganized itself around his laptop. His chest was like armor. His neck muscles felt like steel cables. And his upper back? It had basically given up, letting his shoulders roll forward into a permanent protective hunch.
          </p>

          <p>
            "How many hours a day do you look at screens?" I asked.
          </p>

          <p>
            "I don't know... maybe ten? Twelve if I'm gaming at night."
          </p>

          <p>
            Here's the thing: His body wasn't broken. It was adapting. And that's actually the problem.
          </p>
          ...
          <ul className="space-y-2 my-6">
            ...
            <li>Too much sitting is linked to a 147% higher risk of heart attack or stroke and a 112% higher risk of diabetes</li>
            <li>Sitting can cause anxiety, depression, cancer risk, weak muscles, tight hips, bad backs, and even early death</li>
          </ul>
          ...
          <p>
            I founded <Link to="/" className="text-accent hover:underline">Rock Your Body</Link> because I got tired of watching people's bodies break down from tools that were supposed to make their lives easier. After ten years of movement education and four years studying <Link to="/certifications/anatomy-trains-structural-integration" className="text-accent hover:underline">structural integration under Tom Myers</Link>, I've spent hundreds of hours with my hands in people's fascia, feeling exactly how technology reshapes them.
          </p>
          ...
          <p>
            When you understand the <Link to="/certifications/anatomy-trains-structural-integration" className="text-accent hover:underline">Anatomy Trains</Link>, you see that the body is an interconnected tensegrity system. Every movement affects multiple fascial lines simultaneously.
          </p>
          ...
          <p>
            The good news? Just like you can train your body to be dysfunctional, you can train it to be functional again. That software engineer I mentioned? After twelve sessions of <Link to="/what-is-structural-integration" className="text-accent hover:underline">structural integration</Link> work targeting his fascial lines, combined with <Link to="/what-is-movement-education" className="text-accent hover:underline">movement re-education</Link>, his shoulder pain resolved. Not because I "fixed" his shoulders, but because we reorganized his entire fascial system to support healthy patterns.
          </p>
          ...
          <ul className="space-y-2 my-6">
            ...
            <li>Work with someone who understands whole-body fascial patterns, not just isolated muscle groups</li>
          </ul>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-4 text-sm text-neutralDark/70">
              Let's talk about how we can reorganize your movement patterns
            </p>
          </div>
        </div>
      </article>
...
export default PhoneReshapingSkeleton;
