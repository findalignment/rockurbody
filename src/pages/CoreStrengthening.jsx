    ...
    <PageLayout>
      ...
      <div className="bg-white py-12 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <AvailableLocations serviceName="core strengthening" />
          ...
          <div className="mt-12 pt-8 border-t border-neutralDark/20">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/pregnancy-postpartum" className="text-sm px-4 py-2 bg-sage/10 text-primary rounded-lg hover:bg-sage/20 transition">
