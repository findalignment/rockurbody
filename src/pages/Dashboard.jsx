            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-4 bg-neutralDark/5 rounded-lg opacity-60">
                  ...
                  <div>
                    <h3 className="font-semibold text-neutralDark mb-1">Track Your Session History</h3>
                    <p className="text-sm text-neutralDark/70">Review past sessions and monitor your progress over time</p>
                  </div>
                </div>
