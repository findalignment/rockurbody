...
function ScheduleFullRepatterningPremium() {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8 text-center border-2 border-success">
            ...
            <h1 className="text-3xl md:text-4xl font-heading text-primary mb-4">
              Welcome to Full Repatterning - Premium
            </h1>
            ...
            <div className="bg-warning/20 rounded-xl p-6 text-left mb-6">
              ...
              <p className="text-neutralDark/80 mb-3">
                Full Repatterning - Premium includes <strong>12 SI sessions</strong> (eleven 90-min + one 2-hour) and <strong>24 Movement Education sessions (60 min)</strong>.
              </p>
...
export default ScheduleFullRepatterningPremium;
