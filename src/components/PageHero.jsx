  ...
  return (
    <div className="relative -mt-24 pt-24">
      ...
      >
        ...
        {/* Content - clean solid card */}
        <div className="relative z-10 px-4 max-w-3xl mx-auto w-full">
          <div className="bg-primary/90 backdrop-blur-sm rounded-3xl border-2 border-white/40 py-10 md:py-12 lg:py-14 px-6 md:px-10">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-white mb-5 md:mb-6 text-center">
              {title}
            </h1>
            {subtitle && (
              <p className="text-base md:text-lg lg:text-xl text-white/95 max-w-2xl mx-auto text-center leading-relaxed">
                {subtitle}
              </p>
            )}
          </div>
