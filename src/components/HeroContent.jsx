...
function HeroContent() {
  return (
    <div className="absolute bottom-24 md:top-28 lg:top-36 left-4 right-4 md:right-16 lg:right-24 text-center md:text-right animate-slideDown max-w-2xl md:ml-auto">
      ...
      <h1 className="text-white text-xl md:text-2xl lg:text-3xl mb-4 md:mb-6 lg:mb-8 font-bold leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
        Upgrade Your Body's Software
      </h1>
      
      {/* Pivot to Practical Clarity */}
      <p className="text-white/95 text-sm md:text-base lg:text-lg xl:text-xl font-bold leading-relaxed mb-4 md:mb-6 lg:mb-8 drop-shadow-[0_2px_6px_rgba(0,0,0,0.7)]">
