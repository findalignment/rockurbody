      ...
      <div className="pt-16 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <h2>Personal Training & Bodywork in {city}</h2>
            <p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-neutralLight">
              <h3 className="text-xl font-bold text-primary mb-3">Structural Integration</h3>
              ...
              <ul className="space-y-2 text-sm text-neutralDark/80">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-neutralLight">
              <h3 className="text-xl font-bold text-primary mb-3">Movement Education</h3>
              <p className="text-neutralDark/80 mb-4">
          ...
          {/* Who It's For */}
          <div className="bg-sage/10 p-8 rounded-xl mb-12">
            <h2 className="text-2xl font-bold text-neutralDark mb-4">Who This Is For</h2>
            ...
            <div className="mb-12">
              ...
              <div className="flex flex-wrap gap-2">
                {nearbyAreas.map((area, index) => (
                  <span 
                    key={index}
                    className="px-3 py-1 bg-neutralLight text-neutralDark rounded-full text-sm"
                  >
                    {area}
                  </span>
                ))}
          ...
          {/* How It Works */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-neutralDark mb-6">How Mobile Training Works</h2>
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-neutralDark mb-1">Book Your Session</h4>
                  <p className="text-neutralDark/80">Schedule a free consultation or dive straight into a session. Your choice.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-accent text-white rounded-full flex items-center justify-center font-bold">
                ...
                <div>
                  <h4 className="font-bold text-neutralDark mb-1">I Come to You</h4>
                  <p className="text-neutralDark/80">I bring all necessary equipment to your home, park, or preferred location in {city}.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-accent text-white rounded-full flex items-center justify-center font-bold">
                ...
                <div>
                  <h4 className="font-bold text-neutralDark mb-1">Get Results</h4>
                  <p className="text-neutralDark/80">Move better, feel better, live better. Simple as that.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-primary text-white p-8 rounded-2xl text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Move Better?</h2>
